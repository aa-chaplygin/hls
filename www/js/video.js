...
var Player = function (_Component) {
  ...
  Player.prototype.loadTech_ = function loadTech_(techName, source) {
    ...
    if (source) {
	  ...
	  console.log('AAA V 111 src = ', source.src);
  ...
  Player.prototype.selectSource = function selectSource(sources) {
    ...
    var finder = function finder(_ref2, source) {
      ...
      if (tech.canPlaySource(source, _this4.options_[techName.toLowerCase()])) {
		  console.log('AAA 33333333333', source, techName);
    ...
    if (Array.isArray(source)) {
      ...
      if (source.type && !currentTech.canPlaySource(source, this.options_[this.techName_.toLowerCase()])) {
        ...
        this.sourceList_([source]);
		  ...
		  console.log('AAA src 333 = ', source.src);
        this.cache_.src = source.src;
        this.currentType_ = source.type || '';
  ...
  Player.prototype.sourceList_ = function sourceList_(sources) {
    ...
    if (sourceTech) {
      if (sourceTech.tech === this.techName_) {
		...
		console.log('AAA src 2 = ', sourceTech.source);
...
var Html5 = function (_Tech) {
  ...
  Html5.prototype.src = function src(_src) {
	...
	console.log('AAA V src 555 = ', _src);
    this.setSrc(_src);
  };
  ...
  Html5.prototype.addRemoteTextTrack = function addRemoteTextTrack() {
    ...
    if (options.src) {
		console.log('AAA src 667 = ', options.src);
...
'playbackRate'].forEach(function (prop) {
  Html5.prototype['set' + (0, _toTitleCase2['default'])(prop)] = function (v) {
    console.log('AAA V 555 555 ', prop, '  ', v);
    this.el_[prop] = v;
  };
});
...
var MediaLoader = function (_Component) {
  ...
  function MediaLoader(player, options, ready) {
    ...
    if (!options.playerOptions.sources || options.playerOptions.sources.length === 0) {
	  ...
	  console.log('AAA V MediaLoader src = ', options.playerOptions.sources)
...
Tech.withSourceHandlers = function (_Tech) {
  ...
  _Tech.selectSourceHandler = function (source, options) {
    ...
    for (var i = 0; i < handlers.length; i++) {
      ...
      if (can) {
		console.log('AAA 111111111111111111 can = ',handlers[i]);
        return handlers[i];
      }
    }
  ...
  _Tech.canPlaySource = function (srcObj, options) {
    ...
    if (sh) {
		...
		console.log('AAA 22222222 ', sh.canHandleSource(srcObj, options));
...
var HTMLTrackElement = function (_EventTarget) {
  ...
  function HTMLTrackElement() {
	...
	console.log('AAA src 777 = ', track.src);
...
var textTracksToJson = function textTracksToJson(tech) {
  ...
  var tracks = Array.prototype.map.call(trackEls, function (trackEl) {
    ...
    if (trackEl.src) {
		console.log('AAA src 888 = ', trackEl.src);
...
var TextTrack = function (_Track) {
  ...
  function TextTrack() {
    ...
    if (settings.src) {
		console.log('AAA src 999 = ', settings.src);
      tt.src = settings.src;
...
function createXHR(uri, options, callback) {
	//console.log('AAA V createXHR ', uri);
    options = initParams(uri, options, callback)
    return _createXHR(options)
}
...
function _createXHR(options) {
    ...
    if (!xhr) {
        if (options.cors || options.useXDR) {
			...
			if (options.uri == "https://wowza.peer5.com/vod/mp4:orion.mp4/media_w71466839_1.ts")
			{
				console.log('AAA V createXHR.XMLHttpRequest ', options);
			}
    ...
    xhr.send(body)
	if (xhr.url == "https://wowza.peer5.com/vod/mp4:orion.mp4/media_w71466839_1.ts")
	{
		console.log('AAA V xhr = ', xhr);
	}
    return xhr
}
